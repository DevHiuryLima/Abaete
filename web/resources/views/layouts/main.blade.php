...
<head>
  ...
  @if(Route::currentRouteName() == 'redireciona.login' || Route::currentRouteName() == 'dashboard')
  ...
  @if(Route::currentRouteName() == 'terras' || Route::currentRouteName() == 'site.terras')
    <link rel="stylesheet" type="text/css" href="{{ asset('css/mapa-de-terras.css') }}">
  @endif

  @if(Route::currentRouteName() == 'site.listar.terra' || Route::currentRouteName() == 'listar.terra')
  ...
  @if(Route::currentRouteName() == 'site.listar.terra' || Route::currentRouteName() == 'listar.terra' || Route::currentRouteName() == 'redireciona.criar.terra' || Route::currentRouteName() == 'redireciona.editar.terra' || Route::currentRouteName() == 'redireciona.criar.quiz' || Route::currentRouteName() == 'redireciona.editar.quiz' || Route::currentRouteName() == 'redireciona.criar.administrador' || Route::currentRouteName() == 'redireciona.editar.administrador')
  ...
  @if(Route::currentRouteName() == 'site.terras' || Route::currentRouteName() == 'terras' || Route::currentRouteName() == 'administradores' || Route::currentRouteName() == 'quizzes')
