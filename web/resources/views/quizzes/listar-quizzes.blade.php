...
<div id="root">
    <div id="page-map">
        ...
        <div class="container" style="width: 100%; height: 100%; position: relative; overflow-y: auto;">
            ...
            <ul class="responsive-table">
                <li class="table-header">
                    ...
                    <div class="col col-3">Verdadeiro ou Falso</div>
                ...
                <li class="table-row">
                    ...
                    <div class="col col-2" data-label="Tipo pergunta">{{ $quiz->tipo }}</div>
                    ...
                    <div class="col col-3" data-label="Verdadeiro ou Falso">{{ $quiz->verdadeiro_ou_falso }}</div>
                    ...
                    <div class="col col-4" data-label="Ação" style="display: flex; align-items: center;">
                        ...
                        <button id="remover-admin" class="remover-admin" title="Remover administrador" data-administrador="">
        ...
        <a class="criar-admin" href="{{ route('criar-quiz') }}" title="Criar quiz">
